...
def hoeren2(i):
 ...
 script_ru=f"Добро пожаловать на информационную встречу по теме «{TOPICS_RU[topic]}». Мероприятие начинается в 18:00, двери открываются в 17:30. Первая неделя бесплатная, затем участие стоит пять евро. Пожалуйста, возьмите удостоверение личности, но не приносите свои напитки. После основной части будет двадцать минут для вопросов. Краткая информация появится онлайн на следующий день."
...
def speaking(a,i):
 ...
 return {**common(f"S-A{a}-{i+1:02d}","Sprechen",a,"speaking_recording",topic,"spoken_interaction"),"instruction_de":instr,"instruction_ru":instr_ru,"sample":sample,"sample_translation":sample_ru,"phrase_bank":["Ich würde ... vorschlagen.","Was meinst du?","Ein Vorteil ist ...","Meiner Meinung nach ...","Ich habe noch eine Frage: ..."],"glossary":glossary(),"rubric_status":"VERIFIED","rubric":{"task_completion":4,"coherence":4,"vocabulary":4,"grammar":4,"interaction":4},"translation":"Перевод образца доступен.",**extra}
def svg(path,label):
