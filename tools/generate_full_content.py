...
def writing(a,i):
 ...
 if a==3: sample=sample.replace("am Dienstag",["am Montag","am Dienstag","am Mittwoch","am Donnerstag","am Freitag"][i%5]).replace("Donnerstag",["Dienstag","Mittwoch","Donnerstag","Freitag","Montag"][i%5])
