...
const TASKS={
  ...
  'train-lesen-paraphrase':{module:'Lesen',skill:'L.T1.CORR.M04',type:'mc',text:'Wegen einer technischen Störung beginnt der Vortrag heute erst um 19 Uhr statt um 18 Uhr. Der Saal öffnet wie geplant um 17:30.',translation:'Из-за технической неисправности доклад сегодня начнётся только в 19:00 вместо 18:00. Зал откроется по плану в 17:30.',prompt:'Der Vortrag beginnt heute später als ursprünglich geplant.',options:['Richtig','Falsch'],correct:0,trap:'„erst um 19 Uhr statt um 18 Uhr“ означает, что начало перенесено на более позднее время.'},
  'transfer-lesen-paraphrase':{module:'Lesen',skill:'L.T1.CORR.M04',type:'mc',text:'Der Eintritt kostet nichts. Besucher müssen ihren Platz aber vorher online reservieren.',translation:'Вход бесплатный. Однако посетители должны заранее забронировать место онлайн.',prompt:'Der Besuch ist kostenlos, aber eine Reservierung ist nötig.',options:['Richtig','Falsch'],correct:0,trap:'„kostet nichts“ = „kostenlos“, „müssen vorher reservieren“ = „Reservierung ist nötig“.'},
